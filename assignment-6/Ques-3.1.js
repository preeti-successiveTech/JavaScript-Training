...
class person{
    ...
    greeting()
    {
        return "Hii, My name is " + this.name +". I am "+ this.age + " year old. My hobbies are " +this.interests
    }
    farewell()
    {
...
const obj = new person("John",30,"male","Playing chess, movies and travelling");
